...
function showSuccessDialog() {
    alert("Inmate has been successfully added!");
}

function showErrorDialog() {
    alert("Error adding inmate. Please try again.");
}
</script>
...
<body>
<form class="form-horizontal" action="p_reg_dbms.php" method="post" onsubmit="return showSuccessDialog()">	
<fieldset>

<!-- Form Name -->
<legend>Add a new Inmate</legend>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Inmate Name: </label>  
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Inmate Type: </label>  
